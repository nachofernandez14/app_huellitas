...
def ventana_principal(usuario):
	...
	def categorias():
		...
		def seleccion_categoria(opcion):
			if(opcion == 'Crear categoria'):
				...
				placeholder_categoria = "Ingrese la categoria"
				...
				entry_categoria.delete(0, 'end')
				entry_categoria.insert(0, placeholder_categoria)
				entry_categoria.pack()

				entry_categoria.bind("<Button-1>", click)
	...
	def ventas():
		...
		def menu_ventas():
			...
			global label_vender,label_articulos, frame_busqueda, frame_articulos, frame_carrito, entry_busqueda, boton_vender, label_total,label_carrito, label_total_precio, frame_carrito_articulos, frame_carrito_total,label_articulo,label_precio,label_cantidad,label_total,label_total_precio,boton_vender, label_busqueda
